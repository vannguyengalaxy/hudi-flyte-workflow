...
# uses this to understand that you intend to port this function to tmp.
# If you have normal functions in this file, they are not accessible to
# tmp, unless they have the @task decorator.
...
# important differences, it is never executed by tmp-engine. It is like
